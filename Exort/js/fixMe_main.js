jQuery(function($) {
    ...
    $(".owl-5").owlCarousel({
        ...
        pagination: false,
        navigation: false,
        autoPlay: 10000, /* 10000-ori changes in speed */
    });
    ...
    // mememe addon changes
    
    // Owl-carousel 6 item with navigation
    $(".owl-6-nav").owlCarousel({
        items: 6, // number on display
        slideSpeed: 300,
        navigation: true,
        pagination: false,
        autoPlay: 1500, /* add in autoPlay speed */
        itemsDesktop: [1199, 6], // number on size display
        itemsTablet: [992, 4],  // number on size display
        itemsMobile: [479, 2], // number on size display
        navigationText: [
            "<i class='ti-angle-left prev'></i>",
            "<i class='ti-angle-right next'></i>"
        ]
